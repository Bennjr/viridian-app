...
export default function Overlay() {
  ...
  return (
    <section className="draggable bg-c-primary h-screen place-items-center" ref={contentRef}>
      <div className="draggable grid grid-cols-5 border-b border-black" style={{ width: "100vw", height: "75px" }}>
        <button
          onClick={speak}
